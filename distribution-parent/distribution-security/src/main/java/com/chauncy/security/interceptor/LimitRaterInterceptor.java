//package com.chauncy.security.interceptor;
//
//import cn.hutool.core.util.StrUtil;
//import com.chauncy.common.annotation.RateLimiter;
//import com.chauncy.common.constant.SecurityConstant;
//import com.chauncy.common.exception.sys.ServiceException;
//import com.chauncy.security.limit.RedisRaterLimiter;
...
//
//    @Value("${distribution.rateLimit.enable}")
//    private boolean rateLimitEnable;
//
//    @Value("${distribution.rateLimit.limit}")
//    private Integer limit;
//
//    @Value("${distribution.rateLimit.timeout}")
...
////            throw new ServiceException("你手速怎么这么快，请点慢一点");
////        }
//
//        if(rateLimitEnable){
//            String token2 = redisRaterLimiter.acquireTokenFromBucket(SecurityConstant.LIMIT_ALL, limit, timeout);
