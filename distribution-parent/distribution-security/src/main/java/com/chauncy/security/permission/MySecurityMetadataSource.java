...
public class MySecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    public void loadResourceDefine(){
        ...
        ConfigAttribute cfg;
        // 获取启用的权限操作请求
        List<SysPermissionPo> permissions = permissionService.findByTypeAndStatusOrderBySortOrder(SecurityConstant.PERMISSION_OPERATION, SecurityConstant.STATUS_NORMAL);
