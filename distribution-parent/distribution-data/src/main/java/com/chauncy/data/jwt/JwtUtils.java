...
public class JwtUtils {
    ...
    public SysUserPo getUserFromToken(String token) {
        SysUserPo userDetail;
        try {
    ...
    public String generateAccessToken(SysUserPo userDetail) {
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        SysUserPo userDetail = (SysUserPo) userDetails;
...
//                && !isCreatedBeforeLastPasswordReset(created, userDetail.getLastPasswordResetDate())
    ...
    public String generateRefreshToken(SysUserPo userDetail) {
        Map<String, Object> claims = generateClaims(userDetail);
        // 只授于更新 token 的权限
    ...
    private Map<String, Object> generateClaims(SysUserPo userDetail) {
